// src/components/DashboardTwo/DashboardTwo.js
import React from 'react';
import { PieChart, Pie, Cell, ResponsiveContainer } from 'recharts';
import './DashboardTwo.css'; // Or whichever CSS file you are using (e.g., Dashboard.css)
            ...
            <div className="video-info-container">
                <div className="video-details-summary">
                    <a href={youtubeUrl} target="_blank" rel="noopener noreferrer" className="video-link">
                        <img src={thumbnailUrl} alt="Video Thumbnail" className="video-thumbnail" style={{ maxHeight: '180px' }} />
